...
<div id="txtHint">Select Category<select name="cat"><option value="">select</option></select></div>
<div id="txtHint1">Select Size<select name="size"><option value="">select</option></select></div>
<div id="txtHint2">Select Material<select name="material"><option value="">select</option></select></div>


<div>
Add Price:<input type="text" name="price" value="" />$
		<div><input type="submit" name="service" value="Add" /></div>
</div></div>
